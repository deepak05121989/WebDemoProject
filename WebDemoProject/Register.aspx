    ...
    <div>
        ...
        <table cellpadding="11" cellspacing="8" class="auto-style1">
            <tr>
                <td>First Nme</td>
                <td>
                    <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" WatermarkText="First Name" TargetControlID="textFirstName" />
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="textUserId" runat="server" Height="32px" Width="381px" CssClass="auto-style4" AutoPostBack="True" OnTextChanged="textUserId_TextChanged"></asp:TextBox>
